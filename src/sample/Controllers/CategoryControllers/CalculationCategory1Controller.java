...
public class CalculationCategory1Controller {
   ...
   private void initData() {
       ...
       for (int i = 0; i < list.getListOfFurniture().size(); i++) {
           ...
           grossSum += list.listOfFurniture.get(i).getGross();
           sellingSum += list.listOfFurniture.get(i).getSelling();
           managementSum += list.listOfFurniture.get(i).getManagement();
       }
   }
}
