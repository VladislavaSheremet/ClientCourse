...
public class CalculationCategory8Controller {
    Client client;
    ...
    private void initData() {
        ...
        showInrormationAboutProductData.setCategory(8);
