...
public class CalculationCategory7Controller {
    Client client;
    ...
    private void initData() {
        ...
        showInrormationAboutProductData.setCategory(7);
