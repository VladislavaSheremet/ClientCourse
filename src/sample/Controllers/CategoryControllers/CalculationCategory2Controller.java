...
public class CalculationCategory2Controller {
    Client client;
    ...
    private void initData() {
        ...
        showInrormationAboutProductData.setCategory(2);
