...
public class CalculationCategory6Controller {
    Client client;
    ...
    private void initData() {
        ...
        showInrormationAboutProductData.setCategory(6);
