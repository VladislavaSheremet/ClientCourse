...
public class CalculationCategory3Controller {
    Client client;
    ...
    private void initData() {
        ...
        showInrormationAboutProductData.setCategory(3);
